import { highlight_value, highlight_string, parse_string, parse_value, palettes, naturePalettes, paint_ansi, paint_html, paint_log, defaultContainers, defaultHighlightOptions, testdata } from '../index.js';
describe('ASTNode', () => {
    ...
    test('should be assignable from parse_string', () => {
        const node = parse_string('null');
        expect(node).toBeDefined();
    });
    test('should be assignable from parse_value', () => {
        const node = parse_value({ test: 'value' });
        expect(node).toBeDefined();
    });
});
describe('HighlightOptions', () => {
    ...
    test('should allow partial options', () => {
        const paletteOnly = { palette: palettes.bold.dark };
        const containersOnly = { containers: defaultContainers };
        const empty = {};
...
describe('highlight_string', () => {
    ...
    test('should accept optional options parameter', () => {
        ...
        const options = { palette: palettes.bold.dark };
...
describe('parse_string and parse_value equivalence', () => {
    ...
    test('equivalence: nested object', () => {
        ...
        expect(fromValue.properties['person'].properties['name'].value).toBe(fromString.properties['person'].properties['name'].value);
        expect(fromValue.properties['person'].properties['age'].value).toBe(fromString.properties['person'].properties['age'].value);
    });
    ...
    test('equivalence: deeply nested structure', () => {
        ...
        expect(fromValue.basic_type).toBe(fromString.basic_type);
        expect(fromValue.properties['a'].properties['b'].properties['c'].properties['d'].value).toBe(fromString.properties['a'].properties['b'].properties['c'].properties['d'].value);
    });
    ...
    test('equivalence: mixed object with all JSON types', () => {
        ...
        expect(fromValue.properties['object'].properties['nested'].value).toBe(fromString.properties['object'].properties['nested'].value);
    });
});
describe('paint_ansi', () => {
    const options = {
