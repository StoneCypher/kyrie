 ...
 * ```
 */
export function paint(node, policy, options) {
 ...
 * ```
 */
export const paint_ansi = (node, options) => {
 ...
 * ```
 */
export const paint_html = (node, options) => {
 ...
 * ```
 */
export const paint_log = (node, options) => {
