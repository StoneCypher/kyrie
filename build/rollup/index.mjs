...
export { boldPalette, defaultContainers, defaultHighlightOptions, defaultPalette, duskPalette, forestPalette, highlight, paint, parse_string, parse_value, testdata };
