 ...
 */
const PALETTE_COLOR_KEYS = new Set([
 ...
 * ```
 */
function parseKyrieDefault(envValue) {
    ...
    if (trimmedValue.includes('=')) {
        ...
        for (const pair of pairs) {
            ...
            if (PALETTE_COLOR_KEYS.has(trimmedKey)) {
                ...
                if (value.startsWith('#') || /^[a-zA-Z]+$/.test(value)) {
                    ...
                    config.paletteColors[trimmedKey] = value;
                }
                continue;
            }
...
exports.parseKyrieDefault = parseKyrieDefault;
